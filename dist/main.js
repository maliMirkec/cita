...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scss_cita_scss__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scss_cita_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__scss_cita_scss__);
...
const tweenConfig = {
  ...
  ease: __WEBPACK_IMPORTED_MODULE_1_gsap__["Elastic"].easeOut.config(1, 0.5)
};
...
const animateElements = (el) => {
  if (isElementInViewport(el) && !el.classList.contains("animate")) {
    ...
    tl.add(__WEBPACK_IMPORTED_MODULE_1_gsap__["TweenMax"].staggerTo(animateElements, tweenDuration, tweenConfig, tweenDelay));
